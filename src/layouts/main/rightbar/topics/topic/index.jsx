...
export default function Topic({item}){
  return(
    ...
    >
      ...
      {/* eslint-disable-next-line react/prop-types */}
      {item.postCount && (
        <div className="text-[13px] leading-4 text-[#71767b] mt-1">
          {/* eslint-disable-next-line react/prop-types */}
      ...
      <Popover className="absolute top-1.5 right-2 ">
        ...
        <Popover.Panel className="rounded-xl w-[384px] grid absolute top-2 overflow-hidden right-0 bg-black shadow-box z-[1]">
